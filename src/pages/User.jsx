...
function User() {
    ...
    //check if website link has https already
    ...
    //slice website link
    const sliceSite = (website) => {
        const newSite = website.substring(website.indexOf("/") + 2)
        return newSite
    }
                        ...
                        {blog && (
                            <div className="stat">
                                ...
                                <div className="text-lg stat-value">
                                    {checkSite(`${blog}`) ? <a href={`${blog}`} target="_blank" rel="noreferrer">{sliceSite(blog)}</a> 
